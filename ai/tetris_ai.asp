...
% Non è possibile che non venga scelta una posizione
...
:~ bestPos(Y, X, 1), checkCellBusy(X, Y), checkCellBusy(X, Y+1), checkCellBusy(X, Y+2), checkCellBusy(X, Y+3), spawnedTetromino(0, _, _, _, _, _, _). [1@0, Y, X]
